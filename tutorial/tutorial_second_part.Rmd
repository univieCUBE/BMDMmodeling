...
`reactions` is a spreadsheet containing various reaction nomenclature schemes, derived from Chalmers SysBio GitHub page: https://github.com/SysBioChalmers/Mouse-GEM/tree/main/model

Every spreadsheet can be found in `~/spreadsheets` directory on GitHub, therefore please rename absolute paths accordingly.
