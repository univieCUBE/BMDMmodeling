...
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04358', 0.5) % ATP glycolysis
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04474', 0.5) % NADPH in PPP
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR00021', -5.2056e-04) % biomass
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06916', 0) % oxphos atp generation
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR09068', 0) % proline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR09201', 0.3) % citrulline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR02023', 0) % NO production
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06918', 0) % ferricytochrome C to ferrocytochrome C reaction
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03829', -0.2) % AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03829', 0.2) %  AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03811', 0.2) %  ATP [c] + aspartate [c] + citrulline [c] ⇒ AMP [c] + H+ [c] + PPi [c] + argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03813', -0.2) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03813', 0.2) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03827', -0.2) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03827', 0.2) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03825', 0.2) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
...
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04358', 0.0) % ATP glycolysis
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04474', 0.0) % NADPH in PPP
%LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR00021', -5.2056e-04) % biomass
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06916', 0.0) % oxphos atp generation
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR09068', 0.0) % proline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR09201', 0.0) % citrulline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR02023', 0) % NO production
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06918', 0) % ferricytochrome C to ferrocytochrome C reaction
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03829', 0) % AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03829', 0) %  AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03811', 0) %  ATP [c] + aspartate [c] + citrulline [c] ⇒ AMP [c] + H+ [c] + PPi [c] + argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03813', 0) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03813', 0) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03827', 0) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03827', 0) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03825', 0) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
...
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04358', 1) % ATP glycolysis
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR04474', 1) % NADPH in PPP
%LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR00021', -5.2056e-04)% biomass
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06916', 0.0) % oxphos atp generation
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR09068', 0.0) % proline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR09201', 0.1) % citrulline secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR02023', 0.1) % NO production
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR06918', 0) % ferricytochrome C to ferrocytochrome C reaction
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03829', -0.1) % AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03829', 0.1) %  AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03811', -0.1) %  ATP [c] + aspartate [c] + citrulline [c] ⇒ AMP [c] + H+ [c] + PPi [c] + argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03813', -0.1) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03813', 0.1) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03827', -0.1) % AKG [m] + aspartate [m] ⇔ OAA [m] + glutamate [m] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'ub', 'MAR03827', 0.1) % AKG [m] + aspartate [m] ⇔ OAA [m] + glutamate [m] 
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR03825', 0.1) %  H+ [i] + aspartate [m] + glutamate [c] ⇒ H+ [m] + aspartate [c] + glutamate [m]
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR06916_Mouse-GEM', 0) %  ox phos rxn
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'lb', 'MAR06921', 0) % ox phos
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR09133', 0) % pyruvate secretion
LPSModel_v2_updated = setParam(LPSModel_v2_updated, 'eq', 'MAR09438', 0) % urea secretion
...
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR04358', 1) % ATP glycolysis
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR04474', 1) % NADPH in PPP
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'eq', 'MAR06916', 0.0) % oxphos atp generation
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'eq', 'MAR09068', 0.0) % proline secretion
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR02023', 0.1) % NO production
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'eq', 'MAR06918', 0) % ferricytochrome C to ferrocytochrome C reaction
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR03829', -0.1) % AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'ub', 'MAR03829', 0.1) %  AKG [c] + aspartate [c] ⇔ OAA [c] + glutamate 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR03811', -0.1) %  ATP [c] + aspartate [c] + citrulline [c] ⇒ AMP [c] + H+ [c] + PPi [c] + argininosuccinate [c] 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR03813', -0.1) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'ub', 'MAR03813', 0.1) % arginine [c] + fumarate [c] ⇔ argininosuccinate [c] 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR03827', -0.1) % AKG [m] + aspartate [m] ⇔ OAA [m] + glutamate [m] 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'ub', 'MAR03827', 0.1) % AKG [m] + aspartate [m] ⇔ OAA [m] + glutamate [m] 
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR03825', 0.1) %  H+ [i] + aspartate [m] + glutamate [c] ⇒ H+ [m] + aspartate [c] + glutamate [m]
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR06916_Mouse-GEM', 0) %  ox phos rxn
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'lb', 'MAR06921', 0) % ox phos
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'eq', 'MAR09133', 0) % pyruvate secretion
replicate_models.(fn{k}) = setParam(replicate_models.(fn{k}), 'eq', 'MAR09438', 0) % urea secretion
end
...
IL4Model_v2_updated = addRxnsGenesMets(IL4Model_v2_updated, mouseGEM, 'MAR03816', true);
IL4Model_v2_updated = addRxnsGenesMets(IL4Model_v2_updated, mouseGEM, 'MAR09715', true);
IL4Model_v2_updated = addRxnsGenesMets(IL4Model_v2_updated, mouseGEM, 'MAR05013', true);
IL4Model_v2_updated = addRxnsGenesMets(IL4Model_v2_updated, mouseGEM, 'MAR03897', true);
IL4Model_v2_updated = addRxnsGenesMets(IL4Model_v2_updated, mouseGEM, 'MAR03895', true);

fba = solveLP(IL4Model_v2_updated, 1) % still -2.6300e-05


%IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09068', 0.1)
% proline secretion. first inspect proline secretion without this constraint
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03816', 0.0) % ornithine + urea reaction
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR05013', 0.01) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09715', 0.01) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03897', 0.0) % glutamate 5-semialdehyde rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03895', 0.0) % ADP + glutamyl-5-phosphate rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR13081', 0.0) % ferrocytochrome -> ferricytochrome rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR06918', 0.0) % ferricytochrome -> ferrocytochrome rxn
...
%IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09068', 0.1)
% proline secretion. first inspect proline secretion without this constraint
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03816', 5) % ornithine + urea reaction
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR05013', 5) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09715', 5) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03897', 5) % glutamate 5-semialdehyde rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03895', 5) % ADP + glutamyl-5-phosphate rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR13081', 5) % ferrocytochrome -> ferricytochrome rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR06918', 5) % ferricytochrome -> ferrocytochrome rxn
...
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03816', 0.15) % ornithine + urea reaction
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR05013', 0.5) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09715', 0.5) % spermine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03897', 0.1) % glutamate 5-semialdehyde rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR03895', 0.1) % ADP + glutamyl-5-phosphate rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR13081', 0.1) % ferrocytochrome -> ferricytochrome rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR06918', 0.0) % ferricytochrome -> ferrocytochrome rxn
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR09068', 1.0) % proline secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR11426', 1.0) % putrescine secretion
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'lb', 'MAR06916', 5) % ox phos atp producing reaction
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04363', 0.5) % minimize glyco PEP step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04368', 0.5) % minimize glyco ATP producing step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04137', 0.5) % minimize glyco ATP producing step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04137', 0.5) % minimize glyco ATP producing step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04391', 0.5) % minimize glyco ATP producing step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04379', 0.5) % minimize glyco ATP producing step
IL4Model_v2_updated = setParam(IL4Model_v2_updated, 'ub', 'MAR04358', 0.5) % minimize glyco ATP producing step
...
ControlModel_v2 = addRxnsGenesMets(Simplified_Control_GEM_Median, mouseGEM, 'MAR09013', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09041', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR11428', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR10440', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09075', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR10440', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09144', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09423', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR01947', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09026', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09810', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09247', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09259', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR10264', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09071', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR00568', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09083', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09087', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR11404', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09358', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09043', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09075', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09144', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09451', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09064', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09224', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09045', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09857', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09145', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09296', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09423', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09861', true);
%ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09284', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR10342', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR10190', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR09247', true);
ControlModel_v2 = addRxnsGenesMets(ControlModel_v2, mouseGEM, 'MAR11419', true);
...
% reduce glyco, increase ox phos pathways
ControlGapFilledModel = setParam(ControlGapFilledModel, 'lb', 'MAR06916', 4.5) % ox phos 
ControlGapFilledModel = setParam(ControlGapFilledModel, 'lb', 'MAR06921', 1.5) % ox phos 
ControlGapFilledModel = setParam(ControlGapFilledModel, 'lb', 'MAR06918', 1) % ox phos 
ControlGapFilledModel = setParam(ControlGapFilledModel, 'lb', 'MAR13081', 0.5) % ox phos
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR04363', 1) % glyco
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR04368', 2) % glyco
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR04137', 1) % glyco
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR04358', 1) % glyco
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR04379', 1) % glyco
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR09133', 0.2) % pyruvate secretion
ControlGapFilledModel = setParam(ControlGapFilledModel, 'ub', 'MAR09135', 0.2) % lactate secretion
